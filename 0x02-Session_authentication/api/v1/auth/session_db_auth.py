...
class SessionDBAuth(SessionExpAuth):
    """
    SessionDBAuth Class extends SessionExpAuth to manage API
    authentication with session expiration and database storage.
    """
    ...
    def user_id_for_session_id(self, session_id=None):
        """
        Retrieve the User ID by requesting UserSession from the database,
